...
namespace sample1
{
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("Select Count(*) from logintbl Where USERNAME='" + textBox1.Text + "'and PASSWORD ='" + textBox2.Text + "' and GENDER ='" + comboBox1.Text + "'", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            if (dt.Rows[0][0].ToString() == "1")
            {
                SqlDataAdapter sda1 = new SqlDataAdapter("Select GENDER from logintbl Where USERNAME='" + textBox1.Text + "'and PASSWORD ='" + textBox2.Text + "'", con);
